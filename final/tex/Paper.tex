...
\todo{Fix figure captions}

\todo{Add figure labels/references}
...
\caption{Results of modeling world population and GDP by manual modifications based off of minimizing scoring function \label{overflow}}
\end{figure}
...
\caption{Results of modeling U.S. population and GDP by using the least squares method\label{overflow}}
\end{figure}
...
\caption{Results of modeling South Africa population and GDP by using the least square method.  \label{overflow}}
\end{figure}
